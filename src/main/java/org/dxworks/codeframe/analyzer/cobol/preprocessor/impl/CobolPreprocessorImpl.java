...
package org.dxworks.codeframe.analyzer.cobol.preprocessor.impl;
...
import org.dxworks.codeframe.analyzer.cobol.preprocessor.sub.document.impl.CobolDocumentParserImpl;
import org.dxworks.codeframe.analyzer.cobol.preprocessor.sub.line.reader.impl.CobolLineReaderImpl;
import org.dxworks.codeframe.analyzer.cobol.preprocessor.sub.line.rewriter.impl.CobolCommentEntriesMarkerImpl;
import org.dxworks.codeframe.analyzer.cobol.preprocessor.sub.line.rewriter.impl.CobolLineIndicatorProcessorImpl;
import org.dxworks.codeframe.analyzer.cobol.preprocessor.sub.line.writer.CobolLineWriter;
import org.dxworks.codeframe.analyzer.cobol.preprocessor.sub.line.writer.impl.CobolLineWriterImpl;
...
public class CobolPreprocessorImpl implements CobolPreprocessor {
	...
	protected String parseDocument(final List<CobolLine> lines, final List<File> copyFiles,
		...
		final CobolDocumentParserImpl parser = createDocumentParser(copyFiles);
		final String result = parser.processLines(code, format, dialect);
		copyStatements = parser.copyStatements();
		return result;
	}
